...
При сравнении нам нужны  только текущая и предыдущая строки,  поэтому используем 2 массива - previous_dp и current_dp.
В цикле после заполнения current_dp, меняем указатель на previous_dp, а для current_dp заводим новый массив.
...
Получаем ответ в конце массива previous_dp.
