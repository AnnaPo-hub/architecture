...
O(n)  памяти, где k - это количество использованных ключей в хэш-таблице, то есть количество команд put
с уникальными ключами , которое мы получаем в качестве параметра
При этом, стоит добавить, что массив создается фиксированного размера по заданному в конструкторе параметру,
то есть,  если мы знаем, что получим большое количество команд, то и размер массива нужно задавать больше.
