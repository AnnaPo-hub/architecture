...
O(h), где h - высота дерева или
 в случае сбалансированного дерева O(log n), где n - количество узлов дерева, которое  получаем на вход в качестве параметра
 в худшем случае О(n), если дерево имеет вид связанного списка.
