...
Затем снова просеиваем пирамиду и получаем в корне лучшего участника. Итд , пока не получим, начиная с 1-ой ячейки,
...
-- ВРЕМЕННАЯ СЛОЖНОСТЬ --
Получение максимального значения для массива: Методы add и delete выполняются за O(log n)
