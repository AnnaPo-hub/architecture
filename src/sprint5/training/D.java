...
public class D {
    ...
    private static boolean compareTrees(Node head1, Node head2) {
        ...
        if (doNotHaveChildren(head1, head2)) {
            ...
            return compareTrees(head1.right, head2.right) && compareTrees(head1.left, head2.left);
        } else if (haveLeftSameChildren(head1, head2)) {
            return compareTrees(head1.left, head2.left);
        } else if (haveRightSameChildren(head1, head2)) {
            return compareTrees(head1.right, head2.right);
        }
        return false;
    }
