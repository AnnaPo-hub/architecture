...
Относительно дополнительной памяти: используется стек вызовов для хранения аргументов функции.
Объем занимаемого стека зависит от размера массива O( n log n).
При неудачном выборе опорного элемента пространственная сложность  может быть log n.
